...
PREFIX : <http://pid.suncorp.com.au/def/brand/>
PREFIX cs: <http://pid.suncorp.com.au/def/brand>
...
const BRANDS_ORG = `\
<https://linked.data.gov.au/org/suncorp>
    a schema:Organization ;
    schema:name "Suncorp Group Limited" ;
    schema:url "http://www.suncorp.com.au"^^xsd:anyURI ;
.`;

const BRANDS_PERSON = `\
<https://data.suncorp.com.au/person/test-editor>
    a schema:Person ;
...
function brandsScheme(overrides = {}) {
  const o = {
    ...
    definition: '    skos:definition "Brands under Suncorp Group Limited." ;',
    dateCreated: '    schema:dateCreated "2025-02-19"^^xsd:date ;',
    dateModified: '    schema:dateModified "2025-02-19"^^xsd:date ;',
    creator: '    schema:creator <https://linked.data.gov.au/org/suncorp> ;',
...
function brandsStdConcepts(opts = {}) {
  return [
    ...
    brandsConcept(':suncorp', 'Suncorp', { topConcept: true, ...opts.suncorp }),
  ].join('\n\n');
}
...
brandsTests.push({
  ...
  content: file(
    ...
    brandsScheme({ hasTopConcept: '    skos:hasTopConcept\n        :aami ,\n        :gio ,\n        :gio-v2 ,\n        :suncorp ;', dateModified: '    schema:dateModified "2026-02-12"^^xsd:date ;' }),
    brandsConcept(':aami', 'AAMI', { topConcept: true }),
    brandsConcept(':gio', 'GIO', { topConcept: true, endTime: '2026-02-12' }),
    brandsConcept(':gio-v2', 'GIO', { topConcept: true, replaces: ':gio', creator: '<https://data.suncorp.com.au/person/test-editor>', startTime: '2026-02-12' }),
    brandsConcept(':suncorp', 'Suncorp', { topConcept: true }),
  ),
});
...
brandsTests.push({
  ...
  content: file(
    ...
    brandsScheme({ creator: '    schema:creator <https://data.suncorp.com.au/person/test-editor> ;' }),
    brandsStdConcepts(),
  ),
});
...
brandsTests.push({
  ...
  content: file(
    ...
    BRANDS_PREFIXES, BRANDS_ORG,
    brandsScheme({ definition: '    skos:definition "Brands under Suncorp Group Limited."@en ;' }),
    brandsStdConcepts(),
  ),
});
...
anzicTests.push({
  ...
  content: file(
    ...
    anzicConcept('icat:A0111', 'Nursery, Floriculture and Turf Production', { broader: 'icat:A0100', replaces: 'icat:A0110', creator: '<https://data.suncorp.com.au/person/test-editor>', startTime: '2026-02-12' }),
  ),
});
